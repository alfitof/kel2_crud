      ...
      <div className="relative w-full max-w-md max-h-full">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="px-6 py-6 lg:px-8">
            <h3 className="mb-4 mt-5 text-xl font-medium text-gray-900 dark:text-white">
              Delete this product?
            </h3>
            <div className="space-y-6 mb-5" action="#">
              ...
              <div className="flex justify-between">
                ...
                <button
                  onClick={handleModalDeleteClose}
                  className="w-[45%]  text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Cancel
                </button>
              </div>
